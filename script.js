...
const duffSlider = document.querySelector('.duffbeer-slider'),
  advSlider = document.querySelector('.advantages-slider');

if (window.innerWidth < 1019) {
  duffSlider.setAttribute("data-swipe", "true");
  advSlider.setAttribute("data-swipe", "true");
  slider();
}
...
window.addEventListener('resize', () => {
  if (window.innerWidth < 1019) {
    ...
    duffSlider.setAttribute("data-swipe", "false");
    advSlider.setAttribute("data-swipe", "false");
  }
});

//Accordeon
const accClose = document.querySelectorAll('.accClose'),
  cardHeight = document.querySelectorAll('.advantages-grid-card'),
  cardCont = document.querySelectorAll('.advantages-grid-card-content'),
  cardTxt = document.querySelectorAll('.advantages-grid-card-content-txt');
accordeon = document.querySelectorAll('.advantages-grid-card-content-accordeon');

accClose.forEach((i, index) => {
  i.addEventListener("click", function () {
    this.classList.toggle("active");
    if (accordeon[index].style.height > '0px') {
      accordeon[index].style.height = 0;
      accordeon[index].style.padding = 0;
      cardCont[index].style.top = '173px';
      cardTxt[index].style.display = 'block';
    } else {
      accordeon[index].style.height = cardHeight[index].offsetHeight + 'px';
      accordeon[index].style.padding = '20px 20px 56px';
      cardCont[index].style.position = 'absolute';
      cardCont[index].style.top = 0;
      cardTxt[index].style.display = 'none';
    }
  });
})
